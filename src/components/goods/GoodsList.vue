...
export default {
  ...
  methods: {
    ...
    goDetail(id) {
      ...
      // 其中，this.$route是路由的【参数对象】，所有的路由中的参数，params，query都属于它
      // 其中：this.$router是一个路由【导航对象】，用它可以方便使用JS代码，实现路由的前进后退，跳转到新地址
      ...
      //3.传递命名路由
      this.$router.push({name:"goodsinfo",params:{id}});//后面参数相当于params:{id:id}
      // 还有第四种方式，可以去看官网
    }
  }
};
